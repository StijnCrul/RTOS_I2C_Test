...
/* ADCDMA */
#define ADCDMA_DW__BLOCK_HW DW0
#define ADCDMA_DW__BLOCK_NUMBER 0u
#define ADCDMA_DW__CHANNEL_HW DW0_CH_STRUCT0
#define ADCDMA_DW__CHANNEL_NUMBER 0u
#define ADCDMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN0
