...
/* ARM CM4 */
    ...
    #define mI2C_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t mI2C_SCB_IRQ_cfg;

    #define UART_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t UART_SCB_IRQ_cfg;

    #define UART_DMA_INT__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t UART_DMA_INT_cfg;
