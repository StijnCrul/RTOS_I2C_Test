...
const cy_stc_dma_descriptor_config_t DMA_1_Descriptor_2_config =
{
    .retrigger       = CY_DMA_RETRIG_IM,
    .interruptType   = CY_DMA_1ELEMENT,
    .triggerOutType  = CY_DMA_1ELEMENT,
...
cy_stc_dma_descriptor_t DMA_1_Descriptor_2 =
{
    .ctl = 0UL,
    .src = 0UL,
    .dst = 0UL,
...
const cy_stc_dma_descriptor_config_t DMA_1_Descriptor_3_config =
{
    .retrigger       = CY_DMA_RETRIG_IM,
    .interruptType   = CY_DMA_1ELEMENT,
    .triggerOutType  = CY_DMA_1ELEMENT,
...
cy_stc_dma_descriptor_t DMA_1_Descriptor_3 =
{
    .ctl = 0UL,
    .src = 0UL,
    .dst = 0UL,
...
const cy_stc_dma_descriptor_config_t DMA_1_Descriptor_4_config =
{
    .retrigger       = CY_DMA_RETRIG_IM,
    .interruptType   = CY_DMA_1ELEMENT,
    .triggerOutType  = CY_DMA_1ELEMENT,
...
cy_stc_dma_descriptor_t DMA_1_Descriptor_4 =
{
    .ctl = 0UL,
    .src = 0UL,
    .dst = 0UL,
...
void DMA_1_Init(void)
{
    ...
    (void)Cy_DMA_Descriptor_Init(&DMA_1_Descriptor_3, &DMA_1_Descriptor_3_config);
    (void)Cy_DMA_Descriptor_Init(&DMA_1_Descriptor_4, &DMA_1_Descriptor_4_config);
